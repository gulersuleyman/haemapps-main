...
import 'package:user/partner_screens/premium/widgets/plan_card.dart';
...
class _PremiumScreenState extends State<PremiumScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (products.isNotEmpty) {
      // monthly = products.firstWhere((element) => element?.vendorProductId == 'haem_monthly_new');
      annual = products.firstWhere((element) => element?.vendorProductId == 'haem_annual_new');

      final double annualMonthlyPrice = annual!.price.amount / 12;
      const double monthlyMonthlyPrice = 89.99;
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        context.smallGap,
                        Text('Sınırsız kampanya oluştur', style: context.theme.textTheme.bodyLarge?.copyWith(color: Colors.white)),
                      ],
                    ),
                    context.mediumGap,
                    if (products.isEmpty)
  ...
  Future<void> onPurchase() async {
    ...
    switch (selectedPlan) {
      case 'monthly':
        product = products.firstWhere((element) => element?.vendorProductId == 'haem_monthly_new')!;
      case 'annual':
        product = products.firstWhere((element) => element?.vendorProductId == 'haem_annual_new')!;
      default:
